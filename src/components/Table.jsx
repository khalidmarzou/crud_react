...
export default function ({ products, productsSelected, selectProduct, hideCreateForm, action, store }) {
      ...
      <table className="w-full text-sm text-left text-gray-500">
        ...
        <tbody>
          {products.map((product) => {
            return <TR key={product.id} product={product} selectProduct={selectProduct} productsSelected={productsSelected} />;
          })}
          {hideCreateForm ? (
            <tr>
